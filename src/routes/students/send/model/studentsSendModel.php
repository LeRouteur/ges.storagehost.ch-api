...
class studentsSendModel
{
    public function __construct()
    {
    }

    public function send_mail_with_pdf(string $link_to_pdf, string $detail_sheet_name, string $email, int $student_id)
    {
        // Set subject and body
        $subject = "STORAGEHOST - feuille de détail n° " . $student_id;
        $message = "Bonjour,<br/>
        Voici le lien vers la feuille de détail " . $detail_sheet_name . " pour l'élève n° " . $student_id . "<br/><br/>
        ...
        try {
            ...
            $mail->Body = $message;
            $mail->addStringAttachment($binary_content, $detail_sheet_name, $encoding = 'base64', $type = 'application/pdf');
            $mail->send();
